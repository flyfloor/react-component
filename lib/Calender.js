...
var Calender = _react2.default.createClass({
    ...
    handleYearPicker: function handleYearPicker(year) {
        this.setState({
            year: year,
            showYear: false
        });
    ...
    renderYearPicker: function renderYearPicker() {
        ...
        var _loop = function _loop(i) {
            var active = _this.state.year === i ? '_active' : '';
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { href: 'javascript:;', className: '_nav _pre', onClick: function onClick() {
                            _this.handlePreYearRange(beginY);
                        } },
    ...
    render: function render() {
        ...
        var dayNodes = this.state.showYear ? null : _react2.default.createElement(
            'div',
