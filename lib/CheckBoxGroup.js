...
var CheckBoxGroup = exports.CheckBoxGroup = React.createClass({
    ...
    render: function render() {
        ...
        if (children) {
            optionNodes = React.Children.map(children, function (node) {
                var checked = value.indexOf(node.props.value) > -1;
                return React.createElement(CheckBox, _extends({ checked: checked }, node.props, { onChange: _this.handleChange }));
            });
        } else {
            var itemNode = null;
