...
var DateTimePicker = React.createClass({
    ...
    render: function render() {
        ...
        var pickerNode = showDate ? React.createElement(
            ...
            value ? React.createElement(Calender, { showPreview: false, begin: begin,
                end: end, value: new Date(value.getTime()), onChange: this.handleDateChange }) : React.createElement(Calender, { showPreview: false, begin: begin,
        ...
        return React.createElement(
            ...
            React.createElement(
                'div',
                { className: '_input' },
                React.createElement('input', { type: 'text', placeholder: placeHolder, readOnly: true, value: date, onClick: function onClick() {
