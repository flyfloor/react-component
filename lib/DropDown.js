            ...
            var _loop = function _loop(i) {
                ...
                node = React.createElement(
                    ...
                    { key: i,
                        ...
                        selected: selected,
                        onClick: function onClick() {
                            return _this5.handleChangeSelect(pair_val);
                        },
                ...
                if (multi || searchable) {
                    if (_this5.filterTextMatched(filterText, pair_val, pair_label)) optionNodes.push(node);
                } else {
...
var DropDownLabel = function DropDownLabel(props) {
    ...
    return React.createElement(
        'div',
        _extends({ className: className }, _props, { onClick: props.onClick }),
        React.createElement('input', { type: 'text', className: '_transparent', readOnly: true,
    ...
    _createClass(MultiInput, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                tagNodes,
                React.createElement('input', { type: 'text', className: '_input',
