...
var DropDown = React.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        var defaultSelected = _props3.defaultSelected;
    ...
    formatSearchBar: function formatSearchBar(text) {
        ...
        var filterText = _state5.filterText;
        var value = _state5.value;

        var className = '_input';
        if (value === '') {
        ...
        return React.createElement(
            ...
            React.createElement('input', { type: 'text', className: className, ref: 'userInput', value: filterText,
...
DropDown.multiInput = React.createClass({
    ...
    render: function render() {
        ...
        var selectedTags = _props10.selectedTags;
        var filterText = _props10.filterText;
