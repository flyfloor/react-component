...
var Menu = React.createClass({
    ...
    formatChild: function formatChild(node, i, _ref) {
        ...
        var className = _node$props.className;
    ...
    formatSubMenu: function formatSubMenu(node, i, _ref2) {
        ...
        var className = _node$props2.className;
        ...
        return React.createElement(
            ...
            React.createElement(
                Menu,
                _extends({}, children.props, { disabled: disabled, mutex: mutex, popped: popped,
    ...
    render: function render() {
        ...
        var menuNode = this.formatMenu(children);
