...
var Menu = function (_Component) {
    ...
    _createClass(Menu, [{
        ...
        key: 'clearSubmenuSelection',
        value: function clearSubmenuSelection(ref) {
            var baseNode = ReactDOM.findDOMNode(ref || this).parentNode;
...
var SubMenu = function (_Component2) {
    ...
    _createClass(SubMenu, [{
        ...
        value: function toggleSubmenu(status) {
            ...
            var active = status !== undefined ? !status : hasClass(node, '_active');
