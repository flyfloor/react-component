...
var DEFAULT_PREFIX = 'notice-center';
...
var NoticeCenter = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            { className: className, transitionName: className,
...
NoticeCenter.init = function (props) {
    props = props || {};
    var className = props.className || DEFAULT_PREFIX;
    var domId = 'dot_' + className + '_center';
