            ...
            if (!value && defaultChecked) {
                if (options && this.props.options && options.length > 0) {
                    this.setState({
                        ...
                        if (onChange) onChange(_this3.state.value);
                    });
                    return;
                }
            ...
            if (!value && defaultChecked) {
                if (options && options.length > 0) {
                    this.setState({
                        ...
                        if (onChange) onChange(_this4.state.value);
                    });
                    return;
                }
        ...
        value: function render() {
            ...
            if (children) {
                React.Children.map(children, function (node, i) {
                    ...
                    optionNodes.push(React.createElement(Radio, _extends({ key: i }, node.props, { checked: itemChecked, onChange: _this5.toggleChange })));
                });
            } else {
