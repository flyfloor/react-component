...
var RadioGroup = React.createClass({
    ...
    toggleChange: function toggleChange(e, value) {
        ...
        this.setState({ value: value }, function () {
            ...
            if (onChange) onChange(_this.state.value);
        });
    },
    ...
    render: function render() {
        ...
        if (children) {
            React.Children.map(children, function (node, i) {
                ...
                optionNodes.push(React.createElement(Radio, _extends({ key: i }, node.props, { checked: itemChecked, onChange: _this4.toggleChange })));
            });
        } else {
