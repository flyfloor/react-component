...
module.exports = function (Cmp) {
    return function (_Cmp) {
        ...
        _createClass(DefaultCheckedCmp, [{
            ...
            value: function optionsChangeReInitValue() {
                var _this3 = this;

                var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { defaultChecked: false, multi: false },
            ...
            value: function initDefaultValue() {
                ...
                this.setState({
                    ...
                    return onChange(_this4.state.value);
                });
            }
        }]);
