    ...
    var PopUpCmp = function (_Cmp) {
        ...
        _createClass(PopUpCmp, [{
            ...
            value: function triggerSize() {
                var TRG = ReactDOM.findDOMNode(this.trigger);
                return {
            ...
            value: function contentSize() {
                var CONTENT = ReactDOM.findDOMNode(this.content);
            ...
            value: function onTrigger(e, state) {
                ...
                var contentDOM = ReactDOM.findDOMNode(this.content);
                if (contentDOM && (e.target == contentDOM || contentDOM.contains(e.target))) {
                    ...
                    this.setState({
                        ...
                        contentDOM = ReactDOM.findDOMNode(_this2.content);
