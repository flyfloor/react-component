...
var SelectorList = function (_Component) {
    ...
    _createClass(SelectorList, [{
        ...
        value: function initScrollTo(type) {
            ...
            var dom = ReactDOM.findDOMNode(this[type + 'List']);
            if (dom) {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: '_list _hour',
                        ref: function ref(_ref) {
                            _this3.hourList = _ref;
                        } },
                    this.formatSelectList('hour')
                ),
                React.createElement(
                    'div',
                    { className: '_list _minute',
                        ref: function ref(_ref2) {
                            _this3.minuteList = _ref2;
                        } },
                    this.formatSelectList('minute')
                ),
                simple ? null : React.createElement(
                    'div',
                    { className: '_list _second',
                        ref: function ref(_ref3) {
                            _this3.secondList = _ref3;
                        } },
