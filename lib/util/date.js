...
exports.dateStr2Obj = dateStr2Obj;
exports.date2DateStr = date2DateStr;
exports.obj2DateStr = obj2DateStr;
var BEGIN_YEAR = 1900;
var BEGIN_MONTH = 1;
var BEGIN_DAY = 1;
var BEGIN_DATE = BEGIN_YEAR + "-" + BEGIN_MONTH + "-" + BEGIN_MONTH;

function dateStr2Obj(dateStr) {
...
function obj2DateStr(year, month, day) {
