...
function _removeClass(el, className) {
    if (hasClass(el, className)) {
        ...
        el.className = old.replace(' ' + className + ' ', ' ').replace(/(^\s+)|(\s+$)/g, '');
    }
}
...
module.exports = {
    toggleClass: toggleClass, removeClass: removeClass, hasClass: hasClass, addClass: addClass, getClassList: getClassList
};